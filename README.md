...
gas_price_multiplier = 1.1 # this value is multiplied against the dynamic gas_price to ensure that the tx will be accepted
...
[test-image]: https://github.com/informalsystems/hermes/workflows/Integration/badge.svg
